defmodule PhxPackingListWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PhxPackingListWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PhxPackingListWeb.Gettext, "errors", msg, opts)
    # end
